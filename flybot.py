...
def wish_me():
    ...
    speak("I am your assistant for flight booking on flyeasy. Developed by Jishnu")    
...
user.send_keys("jisheras31@gmail.com")
time.sleep(1)
...
speak("Hey Jishnu  your booking has been successfully confirmed.")
speak("Bye bye!")
